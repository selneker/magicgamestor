...
from routers import admin_users, auth, evo, fazercards, fzr_orders, products, orders, payments, events, chat, push, loyalty
...
for r in (auth.router, products.router, orders.router, payments.router, events.router, chat.router, push.router,
          loyalty.router, admin_users.router, evo.router, fazercards.router, fzr_orders.router):
