...
import { Crown, Layers, Receipt, Sparkles, ShoppingCart } from "lucide-react";
...
export function BottomNav() {
  ...
  const items = [
    ...
    { to: "/boutique?type=prime,prime_plus", icon: Crown, label: "Abos", id: "bottom-nav-prime", active: pathname === "/boutique" && search.includes("prime") },
    { to: "/pack-evolutif", icon: Layers, label: "Pack évo", id: "bottom-nav-evo", active: pathname.startsWith("/pack-evolutif") },
